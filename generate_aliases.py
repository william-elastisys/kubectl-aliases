...
def main():
    ...
    res = [
        ...
        ('a',     'all',                                      ['g'],                      None),
        ('c',     '-n capi-cluster cluster',                  ['g', 'd', 'rm', 'e'],      None),
        ('m',     '-n capi-cluster machine',                  ['g', 'd', 'rm', 'e'],      None),
        ('md',    '-n capi-cluster machinedeployment',        ['g', 'd', 'rm', 'e'],      None),
        ('ms',    '-n capi-cluster machinesets',              ['g', 'd', 'rm', 'e'],      None),
        ('kacfg', '-n capi-cluster kubeadmconfig',            ['g', 'd', 'rm', 'e'],      None),
        ('kacp',  '-n capi-cluster kubeadmcontrolplane',      ['g', 'd', 'rm', 'e'],      None),
        ('oc',    '-n capi-cluster openstackcluster',         ['g', 'd', 'rm', 'e'],      None),
        ('om',    '-n capi-cluster openstackmachine',         ['g', 'd', 'rm', 'e'],      None),
        ('omt',   '-n capi-cluster OpenStackMachineTemplate', ['g', 'd', 'rm', 'e'],      None),
